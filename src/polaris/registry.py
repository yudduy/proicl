...
CONDITION_REGISTRY: dict[str, ConditionSpec] = {
    ...
    "proicl_gepa_mcmc": ConditionSpec(
        ...
        label="ProICL GEPA archive + mixed-alpha MCMC",
        compatible_tracks=("*",),
        uses_archive=True,
        uses_power_sampling=True,
        uses_memory=False,
    ...
    "mixed_alpha_mcmc": ConditionSpec(
        key="mixed_alpha_mcmc",
        label="Mixed-alpha MCMC",
        compatible_tracks=("*",),
        uses_archive=False,
        uses_power_sampling=True,
        uses_memory=False,
    ...
    "fork_search": ConditionSpec(
        key="fork_search",
        label="Entropy-gated fork search",
        compatible_tracks=("*",),
        uses_archive=False,
        uses_power_sampling=False,
        uses_memory=False,
    ...
    "proicl_gepa_mcmc_repair": ConditionSpec(
        key="proicl_gepa_mcmc_repair",
        label="ProICL GEPA archive + mixed-alpha MCMC + verifier repair",
        compatible_tracks=("*",),
        uses_archive=True,
        uses_power_sampling=True,
        uses_memory=False,
    ...
    "proicl_gepa_mcmc_fork_repair": ConditionSpec(
        key="proicl_gepa_mcmc_fork_repair",
        label="ProICL GEPA archive + mixed-alpha MCMC + fork search + verifier repair",
        compatible_tracks=("*",),
        uses_archive=True,
        uses_power_sampling=True,
        uses_memory=False,
    ...
    "proicl_gepa_mcmc_fork_repair_memory": ConditionSpec(
        key="proicl_gepa_mcmc_fork_repair_memory",
        label="Full ProICL: archive + mixed-alpha MCMC + fork/repair + verified memory",
        compatible_tracks=("*",),
        uses_archive=True,
        uses_power_sampling=True,
        uses_memory=True,
    ...
    "proicl_gepa_mcmc_memory": ConditionSpec(
        ...
        label="Preliminary ProICL GEPA archive + mixed-alpha MCMC + online verified memory",
        compatible_tracks=("*",),
        uses_archive=True,
        uses_power_sampling=True,
        uses_memory=True,
